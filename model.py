...
def predict_attrition_likelihood(input_data):
    ...
    try:
        ...
        simulation_control_system = define_fuzzy_rules(over_time_var, years_var, age_var, work_var, env_var, job_var)
        simulation_instance = ctrl.ControlSystemSimulation(simulation_control_system)
        
        normalized_input = normalize_input(input_data, processed_data, features_to_use)
